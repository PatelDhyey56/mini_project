...
const submitdata = async (value, id) => {
  ...
  if (value == "false") {
    ...
    var data1 = await fetch(`http://localhost:8000/update`, {
      method: "post",
      headers: {
    ...
    var data1 = await fetch(`http://localhost:8000/update/${id}`, {
      method: "post",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
...
const city = async () => {
  const state = await fetch("http://localhost:8000/state/state")
    .then((response) => response.json())
    .catch((e) => {
      console.log(e);
    });
  const city = await fetch("http://localhost:8000/city/city")
    .then((response) => response.json())
    .catch((e) => {
      console.log(e);
    });
...
const changestate = async (state) => {
  const city = await fetch(`http://localhost:8000/city/city/${state}`)
    .then((response) => response.json())
    .catch((e) => {
      console.log(e);
    });
